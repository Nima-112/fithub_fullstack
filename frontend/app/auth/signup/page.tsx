                        ...
                        <div>
                            <label className="flex items-start gap-2 cursor-pointer">
                                <input
                                    ...
                                    onChange={handleChange}
                                    required
                                    className="mt-1 w-4 h-4 rounded border-dark-border bg-dark-bg-primary text-primary-neon focus:ring-primary-neon focus:ring-offset-0"
                                />
                                <span className="text-sm text-dark-text-secondary">
                                    I agree to the{' '}
                                    <Link href="/terms" className="text-primary-neon hover:text-primary-neon-light">
                                        Terms & Conditions
                                    </Link>{' '}
                                    and{' '}
                                    <Link href="/privacy" className="text-primary-neon hover:text-primary-neon-light">
                                        Privacy Policy
                                    </Link>
                                </span>
                            </label>
